 ...
 */
package com.app.questions.jalo;
...
import com.app.questions.constants.QuestionsConstants;



/**
 * This is the extension manager of the Questions extension.
 */
public class QuestionsManager extends GeneratedQuestionsManager
{
	...
	{
		return (QuestionsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QuestionsConstants.EXTENSIONNAME);
	}
	...
	public QuestionsManager() 
	{
		...
		{
			LOG.debug("constructor of QuestionsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QuestionsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QuestionsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
